...
-- -----------------------------------------------------------------------
  ...
  module.moveWindowOneSpace = function(direction)
  ...
  module.moveWindowOneSpaceEnd = function(direction)
...
throwToSpace = function(win, spaceIdx)
...
-- switchToSpace = function(spaceIdx)
--   local currentSpaceId = spaces.activeSpace();
--   local spacesIds = getSpacesIdsTable()
--   local spaceId = spacesIds[spaceIdx]
--   if(spaceId ~= nill and spaceId ~= spacesIds[currentSpaceId])
--   then
--     hs.alert.show(spacesIds[currentSpaceId])
--     hs.alert.show(spacesId)
